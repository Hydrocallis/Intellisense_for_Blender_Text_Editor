...
from console_python import get_console,execute
...
def register():
	...
	if kc:
		...
		addon_intellisense_keymaps.append((km, kmi2))
		...
		addon_intellisense_keymaps.append((km, kmi3))
